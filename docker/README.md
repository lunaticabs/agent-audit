...
- The OpenRouter catalog disables Codex's built-in web search for this model. Enabling it causes Codex to request an OpenRouter server tool, which is unavailable for the configured routing policy; local shell and patch tools remain enabled.
